...
This is the third version that fixes an error in the rulebase of the previous version, 
producing more desirable surfaces of control.
...
def fis_create():   
    ...
    rulebase.append(ctrl.Rule(lh['High'] & dtt['Low'] & tdt['Medium'], suit['Medium']))     # Rule 12
    ...
    rulebase.append(ctrl.Rule(lh['Low'] & dtt['High'] & tdt['High'], suit['Low']))          # Rule 25
